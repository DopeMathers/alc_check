...
public class PrimaryController
{
	...
	try
	{
		...
		if(!menge1Feld.getText().equalsIgnoreCase("0.0") && menge1Feld.getText() != null && !menge1Feld.getText().isEmpty()) menge1Feld.setStyle("-fx-border-color: #81C784; -fx-boarder-width: 4px ;-fx-text-inner-color: #81C784;");
	}
	catch(NumberFormatException e)
	{
		menge1Feld.setText(Alkohol.getString("falscheEingabe"));
		menge1Feld.setStyle("-fx-border-color: #E57373; -fx-boarder-width: 4px ;-fx-text-inner-color: #E57373;");
	}
	try
	{
		if(einlesen3 != null && !einlesen3.isEmpty()) d2a = Double.parseDouble(einlesen3);
		if(!menge2Feld.getText().equalsIgnoreCase("0.0") && menge2Feld.getText() != null && !menge2Feld.getText().isEmpty()) menge2Feld.setStyle("-fx-border-color: #81C784; -fx-boarder-width: 4px ;-fx-text-inner-color: #81C784;");
	}
	catch(NumberFormatException e)
	{
		menge2Feld.setText(Alkohol.getString("falscheEingabe"));
		menge2Feld.setStyle("-fx-border-color: #E57373; -fx-boarder-width: 4px ;-fx-text-inner-color: #E57373;");
	}
	try
	{
		if(einlesen4 != null && !einlesen4.isEmpty()) d3a = Double.parseDouble(einlesen4);
		if(!menge3Feld.getText().equalsIgnoreCase("0.0") && menge3Feld.getText() != null && !menge3Feld.getText().isEmpty()) menge3Feld.setStyle("-fx-border-color: #81C784; -fx-boarder-width: 4px ;-fx-text-inner-color: #81C784;");
	}
	catch(NumberFormatException e)
	{
		menge3Feld.setText(Alkohol.getString("falscheEingabe"));
		menge3Feld.setStyle("-fx-border-color: #E57373; -fx-boarder-width: 4px ;-fx-text-inner-color: #E57373;");
	}
	try
	{
		if(einlesen5 != null && !einlesen5.isEmpty()) d4a = Double.parseDouble(einlesen5);
		if(!menge4Feld.getText().equalsIgnoreCase("0.0") && menge4Feld.getText() != null && !menge4Feld.getText().isEmpty()) menge4Feld.setStyle("-fx-border-color: #81C784; -fx-boarder-width: 4px ;-fx-text-inner-color: #81C784;");
	}
	catch(NumberFormatException e)
	{
		menge4Feld.setText(Alkohol.getString("falscheEingabe"));
		menge4Feld.setStyle("-fx-border-color: #E57373; -fx-boarder-width: 4px ;-fx-text-inner-color: #E57373;");
	}
	try
	{
		if(einlesen6 != null && !einlesen6.isEmpty()) d5a = Double.parseDouble(einlesen6);
		if(!menge5Feld.getText().equalsIgnoreCase("0.0") && menge5Feld.getText() != null && !menge5Feld.getText().isEmpty()) menge5Feld.setStyle("-fx-border-color: #81C784; -fx-boarder-width: 4px ;-fx-text-inner-color: #81C784;");
	}
	catch(NumberFormatException e)
	{
		menge5Feld.setText(Alkohol.getString("falscheEingabe"));
		menge5Feld.setStyle("-fx-border-color: #E57373; -fx-boarder-width: 4px ;-fx-text-inner-color: #E57373;");
	}
	
	try
	{
		if(einlesen7 != null && !einlesen7.isEmpty()) d1m = Double.parseDouble(einlesen7);
		if(!ml1Feld.getText().equalsIgnoreCase("0.0") && ml1Feld.getText() != null && !ml1Feld.getText().isEmpty()) ml1Feld.setStyle("-fx-border-color: #81C784; -fx-boarder-width: 4px ;-fx-text-inner-color: #81C784;");
	}
	catch(NumberFormatException e)
	{
		ml1Feld.setText(Alkohol.getString("falscheEingabe"));
		ml1Feld.setStyle("-fx-border-color: #E57373; -fx-boarder-width: 4px ;-fx-text-inner-color: #E57373;");
	}
	try
	{
		if(einlesen8 != null && !einlesen8.isEmpty()) d2m = Double.parseDouble(einlesen8);
		if(!ml2Feld.getText().equalsIgnoreCase("0.0") && ml2Feld.getText() != null && !ml2Feld.getText().isEmpty()) ml2Feld.setStyle("-fx-border-color: #81C784; -fx-boarder-width: 4px ;-fx-text-inner-color: #81C784;");
	}
	catch(NumberFormatException e)
	{
		ml2Feld.setText(Alkohol.getString("falscheEingabe"));
		ml2Feld.setStyle("-fx-border-color: #E57373; -fx-boarder-width: 4px ;-fx-text-inner-color: #E57373;");
	}
	try
	{
		if(einlesen9 != null && !einlesen9.isEmpty()) d3m = Double.parseDouble(einlesen9);
		if(!ml3Feld.getText().equalsIgnoreCase("0.0") && ml3Feld.getText() != null && !ml3Feld.getText().isEmpty()) ml3Feld.setStyle("-fx-border-color: #81C784; -fx-boarder-width: 4px ;-fx-text-inner-color: #81C784;");
	}
	catch(NumberFormatException e)
	{
		ml3Feld.setText(Alkohol.getString("falscheEingabe"));
		ml3Feld.setStyle("-fx-border-color: #E57373; -fx-boarder-width: 4px ;-fx-text-inner-color: #E57373;");
	}
	try
	{
		if(einlesen10 != null && !einlesen10.isEmpty()) d4m = Double.parseDouble(einlesen10);
		if(!ml4Feld.getText().equalsIgnoreCase("0.0") && ml4Feld.getText() != null && !ml4Feld.getText().isEmpty()) ml4Feld.setStyle("-fx-border-color: #81C784; -fx-boarder-width: 4px ;-fx-text-inner-color: #81C784;");
	}
	catch(NumberFormatException e)
	{
		ml4Feld.setText(Alkohol.getString("falscheEingabe"));
		ml4Feld.setStyle("-fx-border-color: #E57373; -fx-boarder-width: 4px ;-fx-text-inner-color: #E57373;");
	}
	try
	{
		if(einlesen11 != null && !einlesen11.isEmpty()) d5m = Double.parseDouble(einlesen11);
		if(!ml5Feld.getText().equalsIgnoreCase("0.0") && ml5Feld.getText() != null && !ml5Feld.getText().isEmpty()) ml5Feld.setStyle("-fx-border-color: #81C784; -fx-boarder-width: 4px ;-fx-text-inner-color: #81C784;");
	}
	catch(NumberFormatException e)
	{
		ml5Feld.setText(Alkohol.getString("falscheEingabe"));
		ml5Feld.setStyle("-fx-border-color: #E57373; -fx-boarder-width: 4px ;-fx-text-inner-color: #E57373;");
	}
	try
	{
		if(einlesen12 != null && !einlesen12.isEmpty()) d1p = Double.parseDouble(einlesen12);
		if(!pro1Feld.getText().equalsIgnoreCase("0.0") && pro1Feld.getText() != null && !pro1Feld.getText().isEmpty()) pro1Feld.setStyle("-fx-border-color: #81C784; -fx-boarder-width: 4px ;-fx-text-inner-color: #81C784;");
	}
	catch(NumberFormatException e)
	{
		pro1Feld.setText(Alkohol.getString("falscheEingabe"));
		pro1Feld.setStyle("-fx-border-color: #E57373; -fx-boarder-width: 4px ;-fx-text-inner-color: #E57373;");
	}
	try
	{
		if(einlesen13 != null && !einlesen13.isEmpty()) d2p = Double.parseDouble(einlesen13);
		if(!pro2Feld.getText().equalsIgnoreCase("0.0") && pro2Feld.getText() != null && !pro2Feld.getText().isEmpty()) pro2Feld.setStyle("-fx-border-color: #81C784; -fx-boarder-width: 4px ;-fx-text-inner-color: #81C784;");
	}
	catch(NumberFormatException e)
	{
		pro2Feld.setText(Alkohol.getString("falscheEingabe"));
		pro2Feld.setStyle("-fx-border-color: #E57373; -fx-boarder-width: 4px ;-fx-text-inner-color: #E57373;");
	}
	try
	{
		if(einlesen14 != null && !einlesen14.isEmpty()) d3p = Double.parseDouble(einlesen14);
		if(!pro3Feld.getText().equalsIgnoreCase("0.0") && pro3Feld.getText() != null && !pro3Feld.getText().isEmpty()) pro3Feld.setStyle("-fx-border-color: #81C784; -fx-boarder-width: 4px ;-fx-text-inner-color: #81C784;");
	}
	catch(NumberFormatException e)
	{
		pro3Feld.setText(Alkohol.getString("falscheEingabe"));
		pro3Feld.setStyle("-fx-border-color: #E57373; -fx-boarder-width: 4px ;-fx-text-inner-color: #E57373;");
	}
	try
	{
		if(einlesen15 != null && !einlesen15.isEmpty()) d4p = Double.parseDouble(einlesen15);
		if(!pro4Feld.getText().equalsIgnoreCase("0.0") && pro4Feld.getText() != null && !pro4Feld.getText().isEmpty()) pro4Feld.setStyle("-fx-border-color: #81C784; -fx-boarder-width: 4px ;-fx-text-inner-color: #81C784;");
	}
	catch(NumberFormatException e)
	{
		pro4Feld.setText(Alkohol.getString("falscheEingabe"));
		pro4Feld.setStyle("-fx-border-color: #E57373; -fx-boarder-width: 4px ;-fx-text-inner-color: #E57373;");
	}
	try
	{
		if(einlesen16 != null && !einlesen16.isEmpty()) d5p = Double.parseDouble(einlesen16);
		if(!pro5Feld.getText().equalsIgnoreCase("0.0") && pro5Feld.getText() != null && !pro5Feld.getText().isEmpty()) pro5Feld.setStyle("-fx-border-color: #81C784; -fx-boarder-width: 4px ;-fx-text-inner-color: #81C784;");
	}
	catch(NumberFormatException e)
	{
		pro5Feld.setText(Alkohol.getString("falscheEingabe"));
		pro5Feld.setStyle("-fx-border-color: #E57373; -fx-boarder-width: 4px ;-fx-text-inner-color: #E57373;");
	}
	...
	if(!gewichtFeld.getText().equalsIgnoreCase("0.0") && gewichtFeld.getText() != null && !gewichtFeld.getText().isEmpty()) gewichtFeld.setStyle("-fx-border-color: #81C784; -fx-boarder-width: 4px ;-fx-text-inner-color: #81C784;");
		}
		catch(NumberFormatException e)
		{
			gewicht = 0;
			gewichtFeld.setText("falscheEingabe");
			gewichtFeld.setStyle("-fx-border-color: #E57373; -fx-boarder-width: 4px ; -fx-text-inner-color: #E57373;");
		}
	}
	else
	{
